...
export declare const favoriteSchema: import("@feathersjs/typebox").TObject<{
...
export declare const favoriteValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const favoriteResolver: import("@feathersjs/schema").Resolver<{
    _id: string | {};
    createdAt: string;
    userId: string;
    propertyId: string;
}, HookContext>;
export declare const favoriteExternalResolver: import("@feathersjs/schema").Resolver<{
    _id: string | {};
    createdAt: string;
    userId: string;
    propertyId: string;
}, HookContext>;
export declare const favoriteDataSchema: import("@feathersjs/typebox").TObject<{
    propertyId: import("@feathersjs/typebox").TString<string>;
}>;
export type FavoriteData = Static<typeof favoriteDataSchema>;
export declare const favoriteDataValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const favoriteDataResolver: import("@feathersjs/schema").Resolver<{
    _id: string | {};
    createdAt: string;
    userId: string;
    propertyId: string;
}, HookContext>;
export declare const favoritePatchSchema: import("@feathersjs/typebox").TPartial<import("@feathersjs/typebox").TOmit<import("@feathersjs/typebox").TObject<{
    _id: import("@feathersjs/typebox").TUnion<[import("@feathersjs/typebox").TString<string>, import("@feathersjs/typebox").TObject<{}>]>;
    userId: import("@feathersjs/typebox").TString<string>;
    propertyId: import("@feathersjs/typebox").TString<string>;
    createdAt: import("@feathersjs/typebox").TString<"date-time">;
}>, ["_id", "userId", "propertyId", "createdAt"]>>;
export type FavoritePatch = Static<typeof favoritePatchSchema>;
export declare const favoritePatchValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const favoritePatchResolver: import("@feathersjs/schema").Resolver<{
    _id: string | {};
    createdAt: string;
    userId: string;
    propertyId: string;
}, HookContext>;
export declare const favoriteQueryProperties: import("@feathersjs/typebox").TPick<import("@feathersjs/typebox").TObject<{
    _id: import("@feathersjs/typebox").TUnion<[import("@feathersjs/typebox").TString<string>, import("@feathersjs/typebox").TObject<{}>]>;
    userId: import("@feathersjs/typebox").TString<string>;
    propertyId: import("@feathersjs/typebox").TString<string>;
    createdAt: import("@feathersjs/typebox").TString<"date-time">;
}>, ["_id", "userId", "propertyId", "createdAt"]>;
export declare const favoriteQuerySchema: import("@feathersjs/typebox").TIntersect<[import("@feathersjs/typebox").TIntersect<[import("@feathersjs/typebox").TPartial<import("@feathersjs/typebox").TObject<{
    ...
    $select: import("@feathersjs/typebox").TUnsafe<("_id" | "createdAt" | "userId" | "propertyId")[]>;
...
export declare const favoriteQueryValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const favoriteQueryResolver: import("@feathersjs/schema").Resolver<Partial<{
    $limit: number;
    $skip: number;
    $sort: {
    ...
    $select: ("_id" | "createdAt" | "userId" | "propertyId")[];
    $and: ({
        _id?: string | {} | Partial<{
            $gt: string | {};
            $gte: string | {};
