...
const roleRequests = (app) => {
    ...
    app.service(exports.roleRequestsPath).hooks({
        ...
        before: {
            ...
            find: [(0, authenticate_if_external_1.authenticateIfExternal)('jwt'), restrictFindToSelfOrAdmin],
            get: [(0, authenticate_if_external_1.authenticateIfExternal)('jwt'), restrictFindToSelfOrAdmin],
            create: [
