...
export declare const propertyManagerAssignmentPatchSchema: import("@feathersjs/typebox").TPartial<import("@feathersjs/typebox").TOmit<import("@feathersjs/typebox").TObject<{
    _id: import("@feathersjs/typebox").TUnion<[import("@feathersjs/typebox").TString<string>, import("@feathersjs/typebox").TObject<{}>]>;
    propertyId: import("@feathersjs/typebox").TString<string>;
    managerUserId: import("@feathersjs/typebox").TString<string>;
    landlordId: import("@feathersjs/typebox").TString<string>;
...
export declare const propertyManagerAssignmentPatchResolver: import("@feathersjs/schema").Resolver<Partial<Omit<{
    assignedBy?: string | undefined;
    _id: string | {};
    createdAt: string;
    propertyId: string;
    managerUserId: string;
    landlordId: string;
}, "_id" | "createdAt" | "propertyId" | "managerUserId" | "landlordId">>, HookContext>;
