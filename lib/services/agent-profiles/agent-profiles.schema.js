...
const property_manager_profiles_schema_1 = require("../property-manager-profiles/property-manager-profiles.schema");
exports.agentProfileSchema = typebox_1.Type.Object({
    ...
    defaultFee: typebox_1.Type.Optional(property_manager_profiles_schema_1.defaultFeeSchema),
