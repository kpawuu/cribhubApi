...
class OAuthService {
    ...
    async authenticate(params, result) {
        ...
        const payload = (grant === null || grant === void 0 ? void 0 : grant.response) || ((_a = result === null || result === void 0 ? void 0 : result.session) === null || _a === void 0 ? void 0 : _a.response) || ((_b = result === null || result === void 0 ? void 0 : result.state) === null || _b === void 0 ? void 0 : _b.response);
        if (!payload) {
            throw new errors_1.NotAuthenticated('No valid oAuth response. You must initiate the oAuth flow from the authorize endpoint.');
        }
    ...
    async find(params) {
        ...
        session.headers = {
            referer: headers === null || headers === void 0 ? void 0 : headers.referer
        };
