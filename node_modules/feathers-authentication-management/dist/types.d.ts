...
export interface User {
    ...
    verifyExpires: Date | number;
    verifyChanges: VerifyChanges;
    resetToken: string;
    resetShortToken: string;
    resetExpires: Date | number;
...
export type AuthenticationManagementAction = 'checkUnique' | 'resendVerifySignup' | 'verifySignupLong' | 'verifySignupShort' | 'verifySignupSetPasswordLong' | 'verifySignupSetPasswordShort' | 'sendResetPwd' | 'resetPwdLong' | 'resetPwdShort' | 'passwordChange' | 'identityChange' | 'options';
...
export type AuthenticationManagementSetupOptions = AuthenticationManagementServiceOptions & {
    path: string;
};
export type VerifySignupLongServiceOptions = Pick<AuthenticationManagementServiceOptions, 'service' | 'notifier' | 'sanitizeUserForClient' | 'passParams'>;
export type VerifySignupOptions = VerifySignupLongServiceOptions & {
    app: Application;
};
export type VerifySignupShortServiceOptions = VerifySignupLongServiceOptions & {
    identifyUserProps: string[];
};
export type VerifySignupWithShortTokenOptions = VerifySignupShortServiceOptions & {
    app: Application;
};
export type VerifySignupSetPasswordLongServiceOptions = Pick<AuthenticationManagementServiceOptions, 'service' | 'sanitizeUserForClient' | 'notifier' | 'passwordField' | 'skipPasswordHash' | 'passParams'>;
export type VerifySignupSetPasswordOptions = VerifySignupSetPasswordLongServiceOptions & {
    app: Application;
};
export type PasswordChangeServiceOptions = Pick<AuthenticationManagementServiceOptions, 'service' | 'identifyUserProps' | 'notifier' | 'sanitizeUserForClient' | 'passwordField' | 'skipPasswordHash' | 'passParams'>;
export type PasswordChangeOptions = PasswordChangeServiceOptions & {
    app: Application;
};
export type VerifySignupSetPasswordShortServiceOptions = VerifySignupSetPasswordLongServiceOptions & Pick<AuthenticationManagementServiceOptions, 'identifyUserProps'>;
export type VerifySignupSetPasswordWithShortTokenOptions = VerifySignupSetPasswordShortServiceOptions & {
    app: Application;
};
export type ResetPasswordServiceOptions = Pick<AuthenticationManagementServiceOptions, 'service' | 'skipIsVerifiedCheck' | 'reuseResetToken' | 'notifier' | 'sanitizeUserForClient' | 'passwordField' | 'skipPasswordHash' | 'passParams'>;
export type ResetPasswordOptions = ResetPasswordServiceOptions & {
    app: Application;
};
export type ResetPwdWithShortServiceOptions = ResetPasswordServiceOptions & {
    identifyUserProps: string[];
};
export type ResetPwdWithShortTokenOptions = ResetPwdWithShortServiceOptions & {
    app: Application;
};
export type ResendVerifySignupServiceOptions = Pick<AuthenticationManagementServiceOptions, 'service' | 'identifyUserProps' | 'delay' | 'longTokenLen' | 'shortTokenLen' | 'shortTokenDigits' | 'notifier' | 'sanitizeUserForClient' | 'passParams'>;
export type ResendVerifySignupOptions = ResendVerifySignupServiceOptions & {
    app: Application;
};
export type IdentityChangeServiceOptions = Pick<AuthenticationManagementServiceOptions, 'service' | 'identifyUserProps' | 'delay' | 'longTokenLen' | 'shortTokenLen' | 'shortTokenDigits' | 'notifier' | 'sanitizeUserForClient' | 'passwordField' | 'passParams'>;
export type IdentityChangeOptions = IdentityChangeServiceOptions & {
    app: Application;
};
export type CheckUniqueServiceOptions = Pick<AuthenticationManagementServiceOptions, 'service' | 'passParams'>;
export type CheckUniqueOptions = CheckUniqueServiceOptions & {
    app: Application;
};
export type SendResetPwdServiceOptions = Pick<AuthenticationManagementServiceOptions, 'service' | 'identifyUserProps' | 'skipIsVerifiedCheck' | 'reuseResetToken' | 'resetDelay' | 'sanitizeUserForClient' | 'resetAttempts' | 'shortTokenLen' | 'longTokenLen' | 'shortTokenDigits' | 'notifier' | 'passwordField' | 'passParams'>;
export type SendResetPwdOptions = SendResetPwdServiceOptions & {
    app: Application;
};
